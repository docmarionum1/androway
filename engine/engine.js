...
var Engine = new Class({
  ...
  CreateThreads: function(){
    if(this.settings.useWorkers){
	  ...
	  //Create Input thread
	  this.threads.input.thread = new Worker("engine/engine.input.js");
    ...
    if(this.settings.useGears){
	  ...
	  //Create Artificial Intelligence thread
      this.threads.input.thread = google.gears.factory.create('beta.workerpool');
      
      this.threads.input.thread.onmessage = function(message){
        
      }
      
      this.threads.input.id = this.threads.input.thread.createWorkerFromUrl("engine/engine.input.js");
